...
\begin{figure*}
\centering
\includegraphics[scale=0.35]{figures/surface-hist.pdf}
\includegraphics[scale=0.35]{figures/functional-hist.pdf}
\includegraphics[scale=0.35]{figures/scatterplot.pdf}
...
\begin{figure}
\centering
\includegraphics[scale=0.45]{figures/vector-mse.pdf}
\includegraphics[scale=0.45]{figures/time.pdf}
...
\begin{figure*}
\centering
\includegraphics[scale=0.35]{figures/violin.pdf} \hspace{0.25cm}
\includegraphics[scale=0.35]{figures/response1.pdf}
\hspace{0.25cm}
\includegraphics[scale=0.35]{figures/response14.pdf}
